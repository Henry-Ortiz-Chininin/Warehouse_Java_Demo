...
public class Security  implements ISecurity{
	...
	public String encrypt(String value) {
        ...
        String encryptedvalue = generateSecureValue(value, saltvalue);  
    ...
    private static String generateSecureValue(String password, String salt)   
    {  
        String finalval = null;  
  
        byte[] secureValue = hash(password.toCharArray(), salt.getBytes());  
   
        finalval = Base64.getEncoder().encodeToString(secureValue);  
