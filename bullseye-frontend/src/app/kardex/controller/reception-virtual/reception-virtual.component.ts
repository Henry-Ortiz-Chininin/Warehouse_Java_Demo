...
@Component({
  selector: 'app-reception-virtual',
  templateUrl: './reception-virtual.component.html',
  styleUrls: ['./reception-virtual.component.css']
})
export class ReceptionVirtualComponent implements OnInit {

  today = new Date();
  pipe = new DatePipe('en-US');
  reception: VirtualReception = new VirtualReception();
  ...
  save(){
    this.receptionService.createVirtual(this.reception).subscribe(data => {
      if(data.Status =="OK"){
